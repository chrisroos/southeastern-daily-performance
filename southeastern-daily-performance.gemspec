...
Gem::Specification.new do |s|
  ...
  s.executables = ["convert-all-html-data", "sedpr-to-csv"]
  s.extra_rdoc_files = ["README.md"]
  s.files = ["README.md", "Rakefile", "bin", "test", "lib/southeastern_daily_performance", "lib/southeastern_daily_performance/affected_service.rb", "lib/southeastern_daily_performance/affected_services_report.rb", "lib/southeastern_daily_performance/daily_performance_report.rb", "lib/southeastern_daily_performance.rb", "bin/convert-all-html-data", "bin/sedpr-to-csv"]
